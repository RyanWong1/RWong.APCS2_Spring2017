...
public class FormulaCell extends RealCell {
	...
	public FormulaCell(String text, Spreadsheet sheet) { //constructor to fill super's String field
		this.sheet = sheet;
		setValue(text);
	}
	...
	public String abbreviatedCellText() {			//shorten's formula to being a 10 spaced value
	...
	public String fullCellText() {					//returns true value of formula cell using super method
		return getValue();
	}
